...
public class Exercicio07 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONSULTA TIPO DE TRIÂNGULO");
    ...
    private void buttonConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConsultaActionPerformed
        ...
        if (m1 == m2 && m1 == m3) {
            JOptionPane.showMessageDialog(this, "3 lados iguais:"
                    + "\nTriângulo equilátero");
        } else if (m1 == m2 || m1 == m3 || m2 == m3) {
            JOptionPane.showMessageDialog(this, "2 lados iguais:"
                    + "\nTriângulo isósceles");
        } else {
            JOptionPane.showMessageDialog(this, "3 lados diferentes:"
                    + "\nTriângulo escaleno");
        }
